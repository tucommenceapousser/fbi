...
try:
	...
	print "o' \.=./ `o".center(44)
	print '(o o)'.center(44)
	print (B + '		   ooO' + R + '--(_)--' + B + 'Ooo').center(44)
	print W + ' '
...
def baliho():
	try:
		...
		print R + '_     _'.center(44)
		print P + "				o" + R + "' \.=./ `" + P + "o" + R .center(44)
		print ('		       (' + C + 'o o' + R + ')\n').center(44)
		print ('		 	  ' + M + 'oooO' + R + '--(_)--' + M + 'Oooo' + R).center(44)
		print ' ' + W
		print (C + '			       F' + P + ' B' + Y + ' I').center(44)
		print (W + '		   [' + G +'Facebook Information'+ W + ']').center(44)
		print (W + '			[' + G + 'Modder : ' + F + 'Trhacknon' + W + ']').center(44)
		print ' '
####################################################################
#		    Print In terminal
def show_program():
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'Tr' + R + 'Kn' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'Tr' + P + 'Kn' + W +'/' + R +'Bot ' + W + '>> ')
